...
class btech1{
  ...
  public :
   void showcalender()
   {
    ...
    const char* imagePath = "/Users/vibhutibhardwaj/Desktop/HelpDesk/calender.jpg";
   ...
   {
	 // Provide the path to your image file
    const char* imagePath = "/Users/vibhutibhardwaj/Desktop/HelpDesk/campusmap.jpeg";
  ...
  public :
   ...
   void showhandoutec()
   {
     ...
     switch(inp)
     {
		...
		case 2 : // Open the file for reading
    			inputFile2.open("/Users/vibhutibhardwaj/Desktop/HelpDesk/microelectronics.txt");
				// Check if the file was opened successfully
    			if (!inputFile2.is_open()) 
				{
        			cout<< "Error: Unable to open the file."<<endl;
   ...
   public : 
    ...
    while (getline(inputFile, line)) {
        ...
        if (Faculty_ID == searchId) {
            ...
            break; // Exit the loop after printing the timetable for the found faculty member
        }
    }
...
class information{
   ...
   public:
	...
	{
      // Open the file for reading
    	ifstream inputFile("/Users/vibhutibhardwaj/Desktop/HelpDesk/prospectus.txt");
		// Check if the file was opened successfully
    	if (!inputFile.is_open()) 
		{
        	cout<< "Error: Unable to open the file."<<endl;
	...
	{
      // Open the file for reading
    	ifstream inputFile("/Users/vibhutibhardwaj/Desktop/HelpDesk/scholarship.txt");
		// Check if the file was opened successfully
    	if (!inputFile.is_open()) 
		{
        	cout<< "Error: Unable to open the file."<<endl;
...
class admin{
	...
	public :
	 bool verify(const string& filename, const string& searchId, const string& password) {
        ifstream inputFile(filename);
        if (!inputFile.is_open()) {
            cout << "Error: Unable to open the file." << endl;
            return false;
	...
	void addStudent(const string& filename, const string& name, const string& id, const string& hostel) {
    ofstream outputFile(filename, ios::app | ios::ate); // Open file in append mode and position at the end
    ...
    void updateStudent(const string& filename, const string& searchId, const string& newName, const string& newHostel) {
        ifstream inputFile(filename);
        ...
        rename("/Users/vibhutibhardwaj/Desktop/HelpDesk/temp.txt", filename.c_str());
	...
	void addFaculty(const string& filename, const string& name, const string& id, const string& dept ,const string& tt) {
    ofstream outputFile(filename, ios::app | ios::ate); // Open file in append mode and position at the end
    if (!outputFile.is_open()) {
        cout << "Error: Unable to open the file." << endl;
        return;
...
int main()
{
	...
	string searchId,filename,searchIdf,filenamef,complaint,password,newname,newhostel,newid,newdept,newtt,timetable;
    int input,input1,input2,input3,input4,input5,input6,input7,input8,input9,input10,input11,input12,input13,input14,input15,input16,input17,input18;
	vector<string> statements;
    string statement;

    cout<<"WELCOME TO BANASTHALI VIDYAPITH"<<endl;
    cout<<"How may I assist you today?"<<endl;
    cout<<"\nMenu\n1.Student\n2.Parent/Family\n3.Faculty\n4.More Information\n5.Complaints/Queries\n6.Admin"<<endl;
    cin>>input;
    switch(input)
    {
        case 1 : cout<<"\nChoose the course you're enrolled in:\n1.B.Tech. I year\n2.B.Tech. II Year\n3.B.Tech. III Year\n4.B.Tech. IV Year"<<endl;
                 cin>>input1;
                 switch(input1)
                 {
                    case 1 : cout<<"Choose option you're interested to find out about\n1Academic Calender\n2.Hostel Allocation\n3.Subject Handout\n4.Location\n5.Time Table"<<endl;
                             cin>>input2;
                             switch(input2)
                             {
                              case 1 : //show calender
                                ...
                                case 2 ://Hostel Allocation
										// File path
    									filename = "/Users/vibhutibhardwaj/Desktop/HelpDesk/hostelbtech1.txt";
                ...
                case 2 : cout<<"Choose option you're interested to find out about\n1Academic Calender\n2.Hostel Allocation\n3.Subject Handout\n4.Location\n5.Time Table"<<endl;
                             cin>>input3;
                             switch(input3)
                             {
                                case 1 : //show calender
                ...
                case 3 :     cout<<"Choose option you're interested to find out about\n1Academic Calender\n2.Hostel Allocation\n3.Subject Handout\n4.Location\n5.Time Table"<<endl;
                             cin>>input4;
                             switch(input4)
                             {
                                case 1 : //show calender
                ...
                case 4 :   cout<<"Choose option you're interested to find out about\n1Academic Calender\n2.Hostel Allocation\n3.Subject Handout\n4.Location\n5.Time Table"<<endl;
                             cin>>input5;
                             switch(input5)
                             {
                                case 1 : //show calender
		...
		case 2 : cout<<"\nHow can I help you?\n1.Location\n2.Regarding fee\n3.Contact Office"<<endl;
				 ...
				 switch(input7)
				 {
					...
					case 2 : cout<<"Choose the year your ward is in:\n1.B.Tech. I year\n2.B.Tech. II Year\n3.B.Tech. III Year\n4.B.Tech. IV Year ";
					         cin>>input8;
							 switch(input8)
							{
								case 1 : cout<<"\nMenu\n1.Fee Structure \n2.Modes of Payment";
										 ...
										 switch(input9)
										 {
											case 1 : p1.showfeestruct();
											         break;
											case 2 : p1.showmodesofpay();
											         break;
										 }
										 break;
								...
								case 2 : cout<<"\nMenu\n1.Fee Structure \n2.Modes of Payment";
										 ...
										 switch(input10)
										 {
											case 1 : p2.showfeestruct();
											         break;
											case 2 : p2.showmodesofpay();
											         break;
										 }
										 break;
								...
								case 3 : cout<<"\nMenu\n1.Fee Structure \n2.Modes of Payment";
										 ...
										 switch(input11)
										 {
											case 1 : p3.showfeestruct();
											         break;
											case 2 : p3.showmodesofpay();
											         break;
										 }
										 break;
								...
								case 4 : cout<<"\nMenu\n1.Fee Structure \n2.Modes of Payment";
										 ...
										 switch(input12)
									     {
											case 1 : p4.showfeestruct();
											         break;
											case 2 : p4.showmodesofpay();
											         break;
										 }
										 break;
							}
					...
					case 3 : i1.showcontact();
					         break;
				 }

		

		case 3 :  filenamef = "/Users/vibhutibhardwaj/Desktop/HelpDesk/ttfaculty.txt";
				// Student ID to search for
					cout << "Enter Faculty ID to search: ";
					cin >> searchIdf;
					cout<<"\nMenu:\n1.Show timetable\n2.Show Academic Calender\n3.Location"<<endl;
					cin>>input13;
					switch(input13)
					{
						case 1 : 
		...
		case 4 : cout<<"\nMenu:\n1.Prospectus\n2.Upcoming Events\n3.Five-Fold Activities\n4.Scholarships\n5.Contact Office"<<endl;		         
		         cin>>input14;
				 switch(input14)
				 {
					case 1 : i1.showprospectus();
					         break;
							 //ADD IN MF
					case 2 : i1.showupcomingevents();
					         break;
							 //ADD IN MF
					case 3 : i1.showfivefold();
					         break;
							 //ADD IN MF
                    case 4 : i1.showscholarship();
					        break;
							//ADD IN MF
					case 5 : i1.showcontact();
					         break;
							 //ADD IN MF
		...
		case 5 : //Complaints
				...
				// string complaint;
				cout << "Please enter your complaint (type end after reporting the complaint):\n";
				...
				// Close the file
	 			...
	 			{
					outFile.close();
                    cout << "Complaints have been successfully recorded." << endl;
				}
				break;
		         break;
		case 6 : //admin
						...
						case 1 : cout<<"\nMenu\n1.Add new record\n2.Update record"<<endl;
								 ...
								 switch(input16)
								 {
									case 1 : 
											 ...
											 cin>>newhostel;
											 a1.addStudent("/Users/vibhutibhardwaj/Desktop/HelpDesk/hostelbtech1.txt",newname,newid,newhostel);
											 break;
									...
									case 2 : cout<<"Enter  ID:";
											 ...
											 cout<<"Enter new hostel name:";
											 cin>>newhostel;
											 a1.updateStudent("/Users/vibhutibhardwaj/Desktop/HelpDesk/hostelbtech1.txt",searchId,newname,newhostel);
											 break;
								 }
								 break;

						case 2 : cout<<"\nMenu\n1.Add a new Faculty record"<<endl;
						         cin>>input17;
								 switch(input17)
								 {
									case 1 : cout<<"Enter  ID:";
            								 ...
            								 cout << "Timetable:" << endl;
          								     cout << "9:00-10:00 CS101 Monday" << endl;
           									 ...
           									 cout << "Enter timetable (enter '###' on a separate line to end):\n";
											 ...
											 a1.addFaculty("/Users/vibhutibhardwaj/Desktop/HelpDesk/ttfaculty.txt",newname,newid,newdept,timetable);
											 break;
